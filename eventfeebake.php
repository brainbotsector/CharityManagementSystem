...
if(isset($_POST['Details']))
{
 $hno = trim($_POST["hno"]);
  ...
  $hexpmonth=  trim($_POST['hexpmonth']);
  $hexpyear =  trim($_POST['hexpyear']);
  $hcvv    = trim($_POST['hcvv']);
  
 

  $check_query = "
  SELECT * FROM bakedonate 
  WHERE hno = :hno
  ";
  ...
  if($statement->execute($check_data))
  {
    ...
    else
    {
      ...
      elseif(empty($hexpmonth))
      {
        $message .= ' Exp month is required';
      }
      elseif(empty($hexpyear))
      {
      ...
      if($message == '')
      {
        ...
        $query = "
        INSERT INTO bakedonate
        (hname,hno,hexpmonth,hexpyear,hcvv) 
        VALUES (:hname,:hno,:hexpmonth,:hexpyear,:hcvv)
        ";
...
<body>
<div class="login">
<h2>REGISTER TO PARTICIPATE IN BAKING  EVENT</h2>
      ...
      <form action="/action_page.php">
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <input type="text" id="hexpmonth" name="hexpmonth">
            <div class="row">
              <div class="col-50">
                <label for="expyear">Exp Year</label>
                <input type="text" id="hexpyear" name="hexpyear" >
              </div>
              <div class="col-50">
                <label for="hcvv">CVV</label>
                <input type="text" id="hcvv" name="hcvv" >
              </div>
            </div>
              <div class="col-50">
