            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="tshirt2.png" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="mug03.png" alt="m3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Green Leaves Mug</h3>
                                    <p>Price: Rs. 350.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6" style="left: 450px;">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="bag3.png" alt="b3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Environmental Backpack</h3>
                                    <p>Price: Rs. 600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
